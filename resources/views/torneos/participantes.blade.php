                    ...
                    <div class="p-4 bg-universo-dark rounded-lg hover:bg-universo-dark/80 transition">
                        <div class="flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
                            ...
                            <div class="flex gap-2">
                                ...
                                {{-- Botón de descarga de certificado para ganadores --}}
                                @if(
                                    auth()->check() &&
                                    $torneo->estado == 'Finalizado' &&
                                    $participacion->posicion <= 3 &&
                                    ($participacion->equipo->esMiembro(auth()->user()) || $participacion->equipo->lider_id == auth()->id())
                                )
                                    <a href="{{ route('certificados.descargar', [$torneo, $participacion]) }}"
