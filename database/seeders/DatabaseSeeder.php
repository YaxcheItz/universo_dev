    ...
    public function run(): void
    {
        ...
        $torneoEnCurso = Torneo::updateOrCreate(
            ...
            [
                ...
                'criterios_evaluacion' => ['Innovación' => 30, 'Diseño' => 20, 'Código' => 50],
                'premios' => ['1er Lugar' => 'MacBook Pro', '2do Lugar' => 'Monitor 4K', '3er Lugar' => 'Licencia Laravel Forge'],
        ...
        $torneoProximo = Torneo::updateOrCreate(
            ...
            [
                ...
                'criterios_evaluacion' => ['Precisión' => 60, 'Optimización' => 40],
                'premios' => ['1er Lugar' => '$5000 USD', '2do Lugar' => '$2500 USD'],
                'estado' => 'Próximo',
                'es_publico' => true,
            ]
        );
        ...
        $equipo = Equipo::updateOrCreate(
            ...
            [
                ...
                'max_miembros' => 5,
                'miembros_actuales' => 3,
                'tecnologias' => ['Laravel', 'Vue.js', 'Tailwind CSS', 'MySQL'],
                'estado' => 'Activo',
